...
### connect to pages
from views.viz import live_temp
...
nav_item = dbc.Container(children=[
    dbc.NavItem(dbc.NavLink("Home", href="/", class_name="text-white", external_link=True)),
        ...
        [# external Links
            html.A(
                ...
                dbc.Row(children=[   
                        ...
                        dbc.Col(html.Img(src='/assets/dash-logo-stripe.svg', height="55px")),
                        ],
                    align="center",
                    class_name="g-0",
                ),
         ...
         dbc.Col(children=[dbc.NavbarBrand("FermTrack", class_name="ms-2"),
